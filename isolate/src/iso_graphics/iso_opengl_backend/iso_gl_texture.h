...
ISO_API void iso_gl_flip_surface(SDL_Surface* surface);
ISO_API u32 iso_gl_get_color_format(SDL_Surface* surface);
ISO_API void iso_gl_pack_surface(SDL_Surface* surface);
